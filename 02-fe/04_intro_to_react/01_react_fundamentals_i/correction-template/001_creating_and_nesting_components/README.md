...
*   **Create the Components**:
    ...
    *   Currently, this platform doesn't support multi-javascript files, so download the template to work locally. Then each component will be placed in the `src/components` folder and will be a separate file.
